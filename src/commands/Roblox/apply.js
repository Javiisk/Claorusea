...
export default {
  ...
  async execute(interaction) {
    ...
    // 3. Why you are better than the other applicants?
    const q3 = new TextInputBuilder()
      .setCustomId('q3_better')
      .setLabel('3. Why you are better than the other applicants?')
      .setStyle(TextInputStyle.Paragraph)
      .setRequired(true)
      .setPlaceholder('Answer here...')
      .setMaxLength(1000);
    ...
    const q5 = new TextInputBuilder()
      ...
      .setLabel('5. What are your disadvantages and advantages?')
      .setStyle(TextInputStyle.Paragraph)
      .setRequired(true)
      .setPlaceholder('Answer here...')
      .setMaxLength(1000);
